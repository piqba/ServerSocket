...
namespace ServerSocket
{
        ...
        int SocketBufferSize)
    {
        ...
        /// </summary>
        public EncodingType EncodingType { get; set; } = EncodingType.ASCII;
        /// <summary>
        ...
        private static string DecodeMessage(byte[] buffer, int bytesRead, EncodingType encodingType = EncodingType.ASCII)
        {
            string clientData = encodingType switch
            {
                EncodingType.ASCII => Encoding.ASCII.GetString(buffer, 0, bytesRead),
                EncodingType.UTF8 => Encoding.UTF8.GetString(buffer, 0, bytesRead),
                EncodingType.UTF32 => Encoding.UTF32.GetString(buffer, 0, bytesRead),
                EncodingType.Unicode => Encoding.Unicode.GetString(buffer, 0, bytesRead),
